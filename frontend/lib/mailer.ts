...
.info-box{background:#f3f0fa;border:1.5px solid #d4c8f0;border-radius:8px;padding:12px 16px;margin:16px 0}
...
<div class="info-box">
  <p style="margin:0;font-size:13px;color:#374151;">Seu acesso será feito com o <strong>e-mail</strong> no qual você recebeu esta mensagem: <strong>${to}</strong></p>
</div>
